...
class PromptAssembler:
    ...
    def build(self) -> str:
        parts = [
            "You are Axiom Agent Runtime, a powerful AI coding assistant running in a terminal.",
    ...
    def _project_memory(self) -> str:
        memory_files = [
            Path(self.cwd) / "AXIOM.md",
            Path(self.cwd) / ".axiom" / "AXIOM.md",
            Path(self.cwd) / "AXIOM.local.md",
            Path(self.cwd) / ".axiom" / "AXIOM.local.md",
        ]
        chunks = []
